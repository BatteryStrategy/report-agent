...
_RAG_QUERIES = [
    ...
    "CATL 리스크 위협 약점 경쟁 위험",
]

# Validation 필수 항목(재무·기술·시장·리스크)과 1:1 대응
_TAVILY_QUERIES = [
    "CATL 재무 실적 매출 영업이익 순이익 2024 2025",            # 재무
    "CATL 배터리 기술 경쟁력 LFP NCM 나트륨이온 제품",          # 기술
    "CATL 배터리 시장 점유율 글로벌 고객사 포지셔닝",            # 시장
    "CATL 리스크 위협 약점 경쟁 위험 요인 규제 2024",           # 리스크
]
